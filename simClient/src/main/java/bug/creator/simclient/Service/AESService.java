package bug.creator.simclient.Service;
...
public class AESService {
    ...
    public static void main(String[] args) {
        String data = "1usKwQNRlFBhTxpNcU2SXQ\u003d\u003d";
        String secretKey = "32qMDH5QQGjSb5rR919a9A==";
        log.info("AES key: {}", secretKey);

        String encryptedData = decrypt(data, secretKey);
